            ...
            <form class="update-empresa-form needs-validation" method="POST" novalidate>
                ...
                <div class="row">
                    <div class="col-6">
                        ...
                        <input type="text" class="form-control" id="nit_modal" name="nit" placeholder="Nit" required>
                    ...
                    <div class="col-6">
                        ...
                        <input type="text" class="form-control" id="company_modal" name="name" name="name"
